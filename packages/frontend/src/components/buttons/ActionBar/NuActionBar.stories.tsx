...
const meta: Meta<typeof NuActionBar> = {
  title: "Buttons/NuActionBar",
  component: NuActionBar,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
...
export const Ghost: Story = {
  render: () => (
    <NuActionBar
      ...
      actions={[
        ...
        "separator",
        createHandlerAction({ id: "edit", icon: Edit, label: "Edit" }, () =>
          alert("Edit clicked"),
        ),
        createHandlerAction({ id: "share", icon: Share, label: "Share" }, () =>
          alert("Share clicked"),
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The `ghost` variant renders borderless buttons with a divider between separator-defined groups.",
      },
    },
  },
};
