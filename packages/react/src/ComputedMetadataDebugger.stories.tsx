...
const ComputedMetadataDebugger = () => {
  ...
  const { metadata, isComputing, error } = useComputedMetadata(schema, formData);
  ...
  return (
    <div className="p-4 space-y-4 max-w-md">
      ...
      <div className="bg-blue-50 p-3 rounded">
        ...
        <div className="text-sm">
          <strong>Last Name Label (computed):</strong> {metadata.lastName?.label}
        </div>
        <div className="text-sm">
      ...
      <div className="text-xs text-gray-600">
        <strong>Expected:</strong> Last Name Label should change from "Computed Last Name: John" to "Computed Last Name: [whatever you type]"
      </div>
