...
import type { ApiEndpoints } from ".test-create-schema";

const TOKEN_KEY = ".test-create_auth_token";

export class .testCreateAuthController implements AuthController<ApiEndpoints> {
