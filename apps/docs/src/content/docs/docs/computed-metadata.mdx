...
const productSchema = nu.object({
  ...
  discount: nu.number().withComputedMeta({
    label: 'Discount %',
  }),
}).withComputed({
  name: {
...
const schema = nu.object({
  data: nu.string().withComputedMeta({ label: 'Data' }),
}).withComputed({
  data: {
    description: async (obj) => {
...
const productSchema = nu.object({
  ...
  basePrice: nu.number().withComputedMeta({ label: 'Base Price' }),
  discountPercent: nu.number().withComputedMeta({ label: 'Discount %' }),
  taxRate: nu.number().withComputedMeta({ label: 'Tax Rate %' }),
}).withComputed({
  name: {
...
const userSchema = nu.object({
  ...
  email: nu.string().withComputedMeta({ label: 'Email' }),
  role: nu.string().withComputedMeta({ label: 'Role' }),
}).withComputed({
  email: {
