...
The snapshot is **not** updated after push — migrations define the intended state by construction. See [ADR 0005](./adrs/0005-unified-schema-snapshot.mdx).
...
The snapshot is **not** updated after reset — migrations define the intended state by construction. See [ADR 0005](./adrs/0005-unified-schema-snapshot.mdx).
