...
const schema = nu.object({
  data: nu.string().meta({ label: 'Data' }),
}).withComputed({
  data: {
    description: async (obj) => {
...
const productSchema = nu.object({
  ...
  category: nu.string().meta({ label: 'Category' }),
  basePrice: nu.number().meta({ label: 'Base Price' }),
  discountPercent: nu.number().meta({ label: 'Discount %' }),
  taxRate: nu.number().meta({ label: 'Tax Rate %' }),
}).withComputed({
  name: {
...
const userSchema = nu.object({
  ...
  email: nu.string().meta({ label: 'Email' }),
  role: nu.string().meta({ label: 'Role' }),
}).withComputed({
  email: {
