...
```
example/questlog-backend/db/schema.sql
```
...
code example/questlog-backend/db/schema.sql
```
...
| File/Folder | Purpose |
|-------------|---------|
| `example/questlog-backend/db/schema.sql` | **Source of truth** - SQL schema definition |
| `example/questlog-backend/src/db/schema/` | Drizzle TypeScript schema definitions |
| `example/questlog-backend/docker/dev/postgresql-init/dump.sql` | Dev container init (copy of schema.sql) |
| `example/questlog-backend/docker/test/postgresql-init/dump.sql` | Test container init (copy of schema.sql) |
| `example/questlog-backend/.env.development` | Database connection strings |
