...
This guide explains how to set up and run Nubase example applications locally, including all the different services, ports, and environments.

## Example Applications

The Nubase repository includes two types of example applications:
...
This is a standalone application generated by `npx @nubase/create`. It uses published `@nubase/*` packages from npm and has its own Turborepo configuration.
...
#### Creating the Generated Example
...
:::note
The `examples/generated` folder is git-ignored since it's meant to be regenerated for testing.
:::

## Quick Start (Questlog Example)
