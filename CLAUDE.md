...
When you run the development environment (`npm run dev`), you're running the example application located in the `examples/questlog/` folder. This demonstrates a real-world Nubase application with three interconnected parts:
